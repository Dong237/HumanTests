    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="excalidraw-card mb-8 text-center">
          ...
          <p className="text-lg text-orange-600 italic">{introData.welcome.tagline}</p>
        </div>
        ...
        <div className="excalidraw-card mb-6">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span>🧠</span>
              {introData.talentModel.title}
            </h2>
            <span className="text-2xl transform transition-transform duration-200"
              style={{ transform: expandedSections.has('talents') ? 'rotate(180deg)' : 'rotate(0deg)' }}>
              ▼
            </span>
          </button>
          {expandedSections.has('talents') && (
            <div className="p-6 pt-2 space-y-4">
              <p className="text-gray-700 leading-relaxed">{introData.talentModel.description}</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                {introData.talentModel.dimensions.map((dim) => (
                  <div key={dim.id} className="bg-white p-4 rounded-xl border-2 border-gray-300 hover:border-gray-400 transition-colors">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                            ...
                            content={
                              <div className="space-y-3">
                                ...
                                <div className="bg-amber-50 p-3 rounded-lg border border-amber-200">
                                  <p className="text-amber-800 font-medium">💼 适合职业：{dim.example}</p>
                                </div>
                              </div>
                            }
                          />
                        ...
                        <p className="text-gray-500 text-xs mt-1">例如：{dim.example}</p>
                      </div>
                    </div>
                  </div>
                ))}
                  ...
                  <InfoIcon
                    ...
                    content={
                      <div className="space-y-2">
                        <p>Likert量表是心理学研究中常用的自评工具，通过5个等级来衡量您对每个陈述的符合程度。</p>
                        <p>本测试中，5点量表从"非常不擅长"到"非常擅长"，帮助您精确评估各项天赋的水平。</p>
                      </div>
                    }
                  />
                </h3>
        ...
        <div className="excalidraw-card mb-6">
          <div className="p-6">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-rose-50 p-4 rounded-xl border-2 border-orange-200 mb-6">
            ...
            <div className="text-center">
              <button
                onClick={onStart}
                className="excalidraw-button text-lg px-12 py-4 text-white bg-gradient-to-r from-amber-500 to-rose-500 hover:from-amber-600 hover:to-rose-600 cursor-pointer transition-all transform hover:scale-105"
              >
