...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  const likertOptions = [
    { value: 1, label: '非常不擅长', color: 'bg-red-200 hover:bg-red-300' },
    { value: 2, label: '不太擅长', color: 'bg-orange-200 hover:bg-orange-300' },
    { value: 3, label: '一般', color: 'bg-yellow-200 hover:bg-yellow-300' },
    { value: 4, label: '比较擅长', color: 'bg-green-200 hover:bg-green-300' },
    { value: 5, label: '非常擅长', color: 'bg-blue-200 hover:bg-blue-300' },
  ];
        ...
        <div className="mb-6">
          <div className="flex justify-between mb-2">
            <span className="text-sm font-medium text-gray-700">
              进度: {question.number} / {totalQuestions}
            </span>
            <span className="text-sm font-medium text-gray-700">
              {Math.round(progress)}%
            </span>
          ...
          <div className="progress-bar">
            <div
              className="progress-fill bg-gradient-to-r from-amber-400 to-rose-400"
