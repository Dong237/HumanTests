...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  const likertOptions = [
    ...
    { value: 2, label: '不同意', color: 'bg-orange-200 hover:bg-orange-300' },
    { value: 3, label: '中立', color: 'bg-yellow-200 hover:bg-yellow-300' },
    { value: 4, label: '同意', color: 'bg-green-200 hover:bg-green-300' },
    { value: 5, label: '非常同意', color: 'bg-blue-200 hover:bg-blue-300' },
  ];
