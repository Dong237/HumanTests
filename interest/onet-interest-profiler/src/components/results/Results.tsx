...
import HollandCodeDisplay from './HollandCodeDisplay';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-12 px-4">
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Header */}
        <div className="excalidraw-card text-center bg-gradient-to-r from-indigo-50 to-purple-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="excalidraw-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <InfoIcon
                title="柱状图说明"
                content="柱状图显示您在每个兴趣类型的原始得分。满分40分（10题×4分），得分越高表示该兴趣越强烈。"
              />
            </div>
            <TypeBars scores={result.typeScores} />
          </div>
        </div>
        ...
        {/* Important Notes */}
        <div className="excalidraw-card bg-gradient-to-r from-blue-50 to-indigo-50">
