...
interface HollandCodeDisplayProps {
  hollandCode: string;
  topInterests: TypeScore[];
  allScores: TypeScore[];
}

const HollandCodeDisplay: React.FC<HollandCodeDisplayProps> = ({ hollandCode, topInterests, allScores }) => {
  ...
  return (
    <div className="excalidraw-card bg-gradient-to-br from-indigo-50 to-purple-50">
      <h2 className="text-3xl font-bold mb-2 text-gray-800 flex items-center gap-3">
        <span>🏷️</span>
        您的Holland职业代码
      </h2>
      <p className="text-gray-600 mb-6">基于O*NET测试结果，以下是您的职业兴趣类型分析</p>

      {/* Holland Code Display */}
      <div className="bg-white p-6 rounded-xl border-2 border-purple-300 mb-6 text-center">
        <p className="text-sm text-purple-700 mb-3">您的Holland三字代码</p>
        ...
        <p className="text-3xl font-bold text-purple-800 tracking-widest">{hollandCode}</p>
      </div>

      {/* Career Recommendations based on code */}
      <div className="bg-white p-4 rounded-xl border-2 border-indigo-300 mb-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-bold text-gray-800 text-lg">{interest.rawScore}/40</span>
                  </div>
                  {/* Career tags */}
...
export default HollandCodeDisplay;
