...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  const likertOptions = [
    { value: 1, label: '非常不同意', color: 'bg-red-200 hover:bg-red-300' },
    { value: 2, label: '比较不同意', color: 'bg-orange-200 hover:bg-orange-300' },
    { value: 3, label: '不确定', color: 'bg-yellow-200 hover:bg-yellow-300' },
    { value: 4, label: '比较同意', color: 'bg-lime-200 hover:bg-lime-300' },
    { value: 5, label: '非常同意', color: 'bg-teal-200 hover:bg-teal-300' },
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-teal-50 via-cyan-50 to-sky-50">
      <div className="w-full max-w-3xl">
        ...
        <div className="mb-6">
          ...
          <div className="progress-bar">
            <div
              className="progress-fill bg-gradient-to-r from-teal-400 to-cyan-400"
