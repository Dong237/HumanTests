      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="excalidraw-card mb-6">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span>🧠</span>
              {introData.enneagramModel.title}
            </h2>
            <span className="text-2xl transform transition-transform duration-200"
          ...
          {expandedSections.has('types') && (
            <div className="p-6 pt-2 space-y-4">
              <p className="text-gray-700 leading-relaxed">{introData.enneagramModel.description}</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                {introData.enneagramModel.types.map((type: any) => (
                  <div key={type.id} className="bg-white p-4 rounded-xl border-2 border-gray-300 hover:border-indigo-400 transition-colors">
                            ...
                            content={
                              <div className="space-y-3">
                                ...
                                <div className="bg-indigo-50 p-3 rounded-lg border border-indigo-200">
                                  <p className="text-indigo-800 font-medium">核心特质：{type.trait}</p>
                                </div>
                              </div>
                            }
                          />
        ...
        <div className="excalidraw-card mb-6">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
              <span>🏷️</span>
              {introData.triads.title}
            </h2>
            <span className="text-2xl transform transition-transform duration-200"
              style={{ transform: expandedSections.has('triads') ? 'rotate(180deg)' : 'rotate(0deg)' }}>
              ▼
            </span>
          </button>
          {expandedSections.has('triads') && (
            <div className="p-6 pt-2 space-y-4">
              <p className="text-gray-700 leading-relaxed">{introData.triads.description}</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                {introData.triads.groups.map((group: any, idx: number) => (
                  <div key={idx} className="bg-gradient-to-r from-indigo-50 to-purple-50 p-3 rounded-xl border-2 border-indigo-200">
                    <span className="font-bold text-indigo-800 text-lg">{group.name}</span>
                    <p className="text-gray-600 text-sm mt-1">{group.types}</p>
                  ...
                  <InfoIcon
                    ...
                    content={
                      <div className="space-y-2">
                        ...
                        <p>本测试中,5点量表从"非常不符合"到"非常符合",帮助您精确评估各项人格倾向。</p>
                      </div>
                    }
                  />
                </h3>
