    ...
    <>
      <button
        className={`inline-flex items-center justify-center ${sizeClasses[size]} rounded-full
          bg-purple-100 hover:bg-purple-200 border-2 border-gray-800
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-6 border-b-2 border-gray-800 bg-purple-50">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-purple-200 border-2 border-gray-800
            ...
            <div className="p-4 border-t-2 border-gray-800 bg-gray-50 flex justify-end">
              <button
                onClick={() => setIsModalOpen(false)}
                className="excalidraw-button bg-purple-100 hover:bg-purple-200 text-gray-800"
              >
                知道了
              </button>
            </div>
